...
namespace Api
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void AddApiProblemDetails(IServiceCollection services)
        {
        ...
        private static void AddMediatorHandlers(IServiceCollection services)
        {
        ...
        private static void AddApiPolicies(IServiceCollection services)
        {
